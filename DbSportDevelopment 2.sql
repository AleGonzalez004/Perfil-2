...
CREATE TABLE tb_pedidos (
	...
	fecha_registro DATE NOT NULL DEFAULT (CURRENT_TIME()),
    direccion VARCHAR(255) NOT NULL
);
...
CREATE TABLE tb_tipos_administradores (
    id_tipo_admin INT PRIMARY KEY NOT NULL,
    nombre VARCHAR(50) NOT NULL
);
...
ALTER TABLE tb_administradores ADD CONSTRAINT fk_id_tipo_admin_administradores FOREIGN KEY (id_tipo) REFERENCES tb_tipos_administradores(id_tipo_admin);
...
(1, 'Natael', 'Cano', 'Gerente', '12345', 'correo789@gmail.com', 1),
(2, 'Jesus', 'Ortiz', 'Supervisor', '12345', 'correo3545@gmail.com', 2),
(3, 'Gabito', 'Ballesteros', 'Asistente', '12345', 'correo2455@gmail.com', 3);
